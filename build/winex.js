...
var HOST_NAME, Handlers, WORKER_ID, _Log, clientIp, cluster, factory, os, stripNulls, uncaughtLogger, url, slice = [].slice, hasProp = {}.hasOwnProperty, bind = function (fn, me) { return function () { return fn.apply(me, arguments); }; }, 
// @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
extend1 = function (child, parent) { for (var key in parent) {
