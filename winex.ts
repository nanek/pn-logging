...
var HOST_NAME: any, Handlers, WORKER_ID: any, _Log: any, clientIp: any, cluster, factory, os, stripNulls: any, uncaughtLogger: any, url: any,
  slice = [].slice,
  hasProp = {}.hasOwnProperty,
  bind = function(fn: any, me: any){ return function(){ return fn.apply(me, arguments); }; },
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  extend1 = function(child: any, parent: any) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor(this: any) { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
uncaughtLogger = function(err: any, cleanup: any) {
  var log, other, ref, ref1;
  if (cleanup == null) {
    cleanup = function() {};
  }
  try {
...
Handlers = {
  logUncaughtException: function(err: any) {
    return uncaughtLogger(err);
  },
  uncaughtException: function(err: any) {
    return uncaughtLogger(err, function() {
      return process.exit(1);
    });
  },
  createUncaughtHandler: function(server: any, opts: any) {
    var kill: any;
    if (opts == null) {
      opts = {
        timeout: 30000
  ...
  createExpressHandler: function(express: any, opts: any) {
    var expressHandler: any;
...
factory = function(winstonLogger: any, classMeta: any, opts?: any) {
  ...
  Log = (function() {
    ...
    function Log(this: any, opts: any) {
      var ref1;
      if (opts == null) {
        opts = {};
      }
    ...
    Log.middleware = function(opts: any) {
      if (opts == null) {
        opts = {};
      }
      return function(req: any, res: any, next: any) {
        var _end: any, log: any;
        // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
        log = new Log(opts);
        log.addReq(req);
        res.locals._log = log;
    ...
    Log.prototype.addReq = function(req: any) {
      ...
      return this.meta = Object.assign(this.meta, stripNulls({
    ...
    Log.prototype.addRes = function(res: any) {
      if (res == null) {
        res = {};
      }
      return this.meta = Object.assign(this.meta, {
        resStatus: res.statusCode.toString()
      });
    };

    Log.prototype.addMeta = function(meta: any) {
      if (meta == null) {
        meta = {};
      }
      return this.meta = Object.assign(this.meta, meta);
    };

    Log.prototype.addError = function(error: any) {
      ...
      if (!this.errNoStack) {
        Object.assign(errObj, stripNulls({
      ...
      return this.meta = Object.assign(this.meta, errObj);
    };
    ...
    Log.prototype.baseMeta = function(meta: any, level: any) {
      var ref;
      if (meta == null) {
        meta = {};
      }
    ...
    Log.prototype._makeMeta = function(level: any, meta: any) {
      ...
      meta = Object.assign(this.baseMeta(null, level), this.meta, meta);
      meta.type = type;
      return meta;
    };

    ref = Object.keys(winstonLogger.levels);
    fn = function(level: any) {
      return Log.prototype[level] = function(msg: any, metaOrCb: any, cb: any) {
        var callback, meta;
        if (metaOrCb == null) {
          metaOrCb = {};
        }
        ...
        return winstonLogger[meta.level].apply(winstonLogger, [msg, meta, callback]);
      };
    };
    for (i = 0, len = ref.length; i < len; i++) {
      level = ref[i];
  ...
  NopLog = (function(superClass) {
    ...
    // @ts-expect-error ts-migrate(7023) FIXME: 'NopLog' implicitly has return type 'any' because ... Remove this comment to see the full error message
    function NopLog(this: any) {
      // @ts-expect-error ts-migrate(2339) FIXME: Property '__super__' does not exist on type '{ (th... Remove this comment to see the full error message
      return NopLog.__super__.constructor.apply(this, arguments);
    }

    NopLog.middleware = function() {
      // @ts-expect-error ts-migrate(6133) FIXME: 'req' is declared but its value is never read.
      return function(req: any, res: any, next: any) {
        // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
